...
const MOCK_BLOG_POSTS: BlogPost[] = [
  {
    _id: 'mock_id_1',
    id: 'first-post-welcome-to-hype',
    title: 'Welcome to HYPE: Your Creative Hub in India!',
    excerpt: 'Discover how HYPE is revolutionizing the way clients and designers collaborate in India. Learn about our mission and vision.',
    content: `<p>Welcome to the official HYPE blog!</p>`,
    authorName: 'The HYPE Team',
    ...
    tags: ['welcome', 'hype', 'indian design'],
    views: 1250,
    likes: 150,
    comments: 22,
  },
