...
export const initialUsersData: User[] = [
  ...
  { id: 'admin002', name: 'Super Admin', email: 'super.admin@designflow.com', mobileNumber: '9000000000', roles: ['Super Admin'], avatarUrl: 'https://placehold.co/40x40.png', avatarHint: 'admin', joinDate: new Date(2022, 0, 1), lastLogin: new Date(2024, 5, 4), status: 'Active' },
];
