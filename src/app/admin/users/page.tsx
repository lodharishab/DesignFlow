...
export const initialUsersData: User[] = [
  ...
  { id: 'usr004', name: 'Aditi Singh', email: 'aditi.admin@example.in', mobileNumber: '9654321098', roles: ['Admin'], avatarUrl: 'https://placehold.co/40x40.png', avatarHint: 'indian woman admin', joinDate: new Date(2022, 5, 10), lastLogin: new Date(2024, 5, 4), status: 'Active' },
  ...
  { id: 'usr007', name: 'Arjun Desai', email: 'arjun.creator@example.in', mobileNumber: '9234567890', roles: ['Designer'], avatarUrl: 'https://placehold.co/40x40.png', avatarHint: 'indian man creative', joinDate: new Date(2023, 7, 22), lastLogin: new Date(2024, 4, 30), status: 'Active' },
  ...
  { id: 'usr009', name: 'Karan Malhotra', email: 'karan.m@example.in', mobileNumber: '9456789012', roles: ['Designer', 'Admin'], avatarUrl: 'https://placehold.co/40x40.png', avatarHint: 'indian man business', joinDate: new Date(2022, 8, 1), lastLogin: new Date(2024, 5, 4), status: 'Suspended' },
